...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public void onCreate() {
        ...
        Log.i("MusicService--", "Music Service onCreate");
    ...
    private void initSession() {
        try {
            ...
            mMediaSession = new MediaSessionCompat(this, TAG);  //Android5.0 以上的注册方式
        } catch (Exception e) {
            mMediaSession = null;
        }
        try {
    ...
    public int onStartCommand(Intent startIntent, int flags, int startId) {
        Log.i("MusicService--", "Music Service onStartCommand");
