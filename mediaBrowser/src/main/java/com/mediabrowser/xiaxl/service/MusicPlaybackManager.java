...
public class MusicPlaybackManager implements Playback.PlaybackCallback {
    ...
    public void handlePlayRequest() {
        ...
        if (currentMusic != null) {
            ...
            Log.i("toPlayMediaId"+(i++), ""+mPlayingMediaId);
            //
            ...
            // 当前播放的音频
            Log.i("mPlayingMediaId"+(i++), ""+mPlayingMediaId);
            mPlayingMediaId = currentMusic.getDescription().getMediaId(); //这哥们没有拿到值
    ...
    private class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onCustomAction(@NonNull String action, Bundle extras) {
            ...
            if (CUSTOM_ACTION_MUSIC_UPDATE_QUNEN.equals(action)) {
                Log.i("刘晓慧---------", "lyf---"+extras.getParcelable(CUSTOM_ACTION_MUSIC_PLAY_QUNEN).toString());
