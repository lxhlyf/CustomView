...
public class BigImageFragment extends BaseFragment {
    ...
    protected int provideContentViewId() {
        return R.layout.fragment_big_image1;
    }

    @Override
    protected void initView(View rootView) {

        mIvPic = rootView.findViewById(R.id.pv_pic);
        mCircleProgressView = rootView.findViewById(R.id.progressView);
    }
    ...
    protected void loadData() {
        ...
        imageLoader.setOnGlideImageViewListener(imgUrl, new OnGlideImageViewListener() {
            ...
            public void onProgress(int percent, boolean isDone, GlideException exception) {
                if (exception != null && !TextUtils.isEmpty(exception.getMessage())) {
                    UIUtils.showToast("GlideImageLoader error");
                }
        ...
        requestBuilder.transition(DrawableTransitionOptions.withCrossFade()) // 动画渐变加载
