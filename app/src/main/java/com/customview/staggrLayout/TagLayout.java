...
public class TagLayout extends ViewGroup {
    ...
    private BaseTagAdapter tagAdapter;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //子View的MeasureSpec 取决于父类的MeasureSpec和自身的LayoutParam
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (List<View> childViews : mChildViews) {
            ...
            for (View childView : childViews) {
                ...
                maxTop = Math.max(childView.getMeasuredHeight() + params.topMargin +params.bottomMargin, maxTop);
            }
    ...
    public void setAdapter(BaseTagAdapter adapter){
        if (adapter == null){
            throw new NullPointerException("BaseTagAdapter 在一个空指针上");
        }
