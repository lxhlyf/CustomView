...
import com.customview.musicplayer.MusicPlayerActivity;
    ...
    private void initListener() {
        ...
        lvLocalAudio.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View itemView, int position, long id) {
                ...
                Intent intent = new Intent(LocalAudioActivity.this, MusicPlayerActivity.class);
            ...
            public void run() {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        ...
                        mediaItems.add(item);
                        item.setDisplayName(cursor.getString(0));
